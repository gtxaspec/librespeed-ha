...
class LibreSpeedRunningSensor(LibreSpeedBaseEntity, BinarySensorEntity):
    ...
    def __init__(
        ...
        self._entry = entry
        _LOGGER.debug(
            "Binary sensor initialized, is_running: %s", coordinator.is_running
        )
    ...
    def is_on(self) -> bool:
        ...
        global_lock = self.coordinator.global_lock
        ...
        _LOGGER.debug(
            "Binary sensor: global_lock=%s, waiting=%s, result=%s",
            global_lock_held,
            is_waiting,
            is_any_running,
        )
    ...
    def _handle_coordinator_update(self) -> None:
        ...
        _LOGGER.debug(
            "Binary sensor handling coordinator update, is_running: %s",
